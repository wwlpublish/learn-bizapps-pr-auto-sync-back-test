Before you begin this course, we recommend that you first complete the [Get started with AI Builder](/training/modules/get-started-with-ai-builder/?azure-portal=true) module.
