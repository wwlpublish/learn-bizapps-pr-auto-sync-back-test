...
Select the type of document you want to build an AI model to automate data extraction. There are two options:
...
Enter the field name **Invoice Number** and select **Done**, repeat this step for **Due Date**, **Total amount**, and **Customer ID**.

![Screenshot of defining a field name Invoice Number.](../media/define-field.jpg)

The model will learn how to extract these fields from the document.

![Screenshot of the Power Automate "Choose information to extract" page about four fields name to be extracted from the document.](../media/define-field-02.jpg)
...
![Screenshot of the Power Automate "Choose information to extract" page adding a single Page Table item.](../media/single-page-table-01.jpg)
...
![Screenshot of the Power Automate "Choose information to extract" page defining a table name items and renaming the column name.](../media/single-page-table-02.jpg)

![Screenshot of the Single Page Table.](../media/single-page-table-03.jpg)
...
![Screenshot of the Power Automate Add collections of documents page selecting new collection.](../media/new-collection.jpg)

![Screenshot of the Power Automate "Add collections of documents" page selecting a new collection and changing its name.](../media/new-collection-01.jpg)

![Screenshot of the Power Automate "Add collections of documents" page selecting a second collection and changing its name.](../media/new-collection-02.jpg)
...
![Screenshot of the Power Automate "Add collections of documents" page selecting a collection Adatum.](../media/adatum-add-documents-01.jpg)

Select **Add documents**, and select **My device** as a data source.

![Animated screenshot of the Power Automate "Add collections of documents" page selecting Add documments.](../media/adatum-add-documents-02.jpg)

![Screenshot of the Power Automate "Add collections of documents", "Add documents" page selecting my device as a data source.](../media/adatum-add-documents-03.jpg)

Select five documents from your local device and select upload documents. Those five uploaded documents will be used to train your model.

![Screenshot of the Power Automate "Add collections of documents" page with five documents selected from a data source.](../media/adatum-add-documents-04.jpg)

![Screenshot of Power Automate "Add collections of documents" page uploading five documents from a data source to be used to train a model.](../media/adatum-add-documents-05.jpg)

![Screenshot of Power Automate "Add collections of documents" page showing a document in a collection.](../media/adatum-add-documents-06.jpg)
...
For the collection names **Contoso**, upload the five documents you'll find on the **AI Builder Document processing Sample Data/Contoso/Train** folder.

Once you've uploaded the sample documents to each collection, select **Next** to continue.
...
![Screenshot of the Power Automate "Tag documents" page drawing a rectangle around a field.](../media/tag-field-01.jpg)

![Screenshot of the Power Automate "Tag documents" page selecting a field name.](../media/tag-field-02.jpg)

![Screenshot of the Power Automate "Tag documents" page showing a field name selected.](../media/tag-field-03.jpg)
...
![Screenshot of the Power Automate Tag documents page selecting Not available in the document in the three dotted menu.](../media/tag-field-04.jpg)
...
![Screenshot of the Power Automate "Tag documents" page drawing a rectangle around a table.](../media/new-tag-table-01.jpg)

The content of the panel on the right will change.

![Screenshot of the Power Automate "Tag documents" page showing the right panel that have changed.](../media/new-tag-table-02.jpg)

2.	Draw rows by left clicking between row separators.

![Screenshot of the Power Automate "Tag documents" page drawing rows by left clicking between row separators.](../media/new-tag-table-03.jpg)

![Screenshot of the Power Automate "Tag documents" page showing row separated.](../media/new-tag-table-04.jpg)

3.	Draw columns by pressing Ctrl + left-click (or ⌘  left-click on macOS).

![Screenshot of the Power Automate "Tag documents" page drawing columns by pressing ctrl + left-click.](../media/new-tag-table-05.jpg)
...
![Screenshot of the Power Automate "Tag documents" page assigning and selecting header on the first column.](../media/new-tag-table-06.jpg)

![Screenshot of the Power Automate "Tag documents" page assigning and selecting header on the second column.](../media/new-tag-table-07.jpg)

5.	A preview of how the table will be extracted appears on the panel on the right.

![Screenshot of the Power Automate "Tag documents" page showing a preview of how the table will be extracted.](../media/new-tag-table-08.jpg)
...
![Screenshot of the Power Automate "Tag documents" page ignoring the first row of the table that has been tagged.](../media/new-tag-table-09.jpg)

![Screenshot of the Power Automate "Tag documents" page with the first row of the header ignored.](../media/new-tag-table-10.jpg)
