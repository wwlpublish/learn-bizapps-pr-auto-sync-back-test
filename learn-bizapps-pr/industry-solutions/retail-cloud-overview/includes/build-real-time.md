...
Microsoft Cloud for Retail uses a combination of Microsoft products to address the industry-prioritized scenarios that are focused on building a real-time, sustainable supply chain. The following illustration reflects the required and recommended capabilities.

> [!div class="mx-imgBorder"]
> [![Diagram showing product dependencies for building a real-time, sustainable supply chain.](../media/build.png)](../media/build.png#lightbox)
...
Additionally, you'll gain seamless inventory management:
