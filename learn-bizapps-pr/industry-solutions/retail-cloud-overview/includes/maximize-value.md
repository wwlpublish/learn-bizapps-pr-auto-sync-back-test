...
> [!div class="mx-imgBorder"]
> ![Screenshot of the Virtual fraud analyst, showing steps to select target data and examine the effect of fraud on historical transaction data.](../media/fraud.png)
