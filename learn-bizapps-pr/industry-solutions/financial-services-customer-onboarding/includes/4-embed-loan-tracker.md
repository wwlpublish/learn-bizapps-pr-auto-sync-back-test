...
Additionally, your care team can use Microsoft Teams internally to do the following tasks:
...
> [!NOTE]
> If you’ve already done this in the **Financial Services training environment preparation** module > **Deploy and configure prerequisite components** > **Setup prerequisite configurations**, then you can skip this Task 1 and go to Task 2.
