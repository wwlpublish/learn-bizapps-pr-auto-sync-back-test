...
1. Select **New stage**, enter the **Display Name** as **Quality Check**, and then select **Apply**.
...
**Congratulations**, you've extended the Loan application business process flow by adding another stage for loan applications in Microsoft Cloud for Financial Services.
