...
> [!div class="mx-imgBorder"]
> [![Screenshot showing source have some mandatory definition missings and next action in calculation flow.](../media/data-calculation-source.png)](../media/data-calculation-source.png#lightbox)
