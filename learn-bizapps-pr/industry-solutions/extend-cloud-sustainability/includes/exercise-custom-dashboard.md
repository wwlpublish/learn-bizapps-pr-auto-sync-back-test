...
1. On the Home screen, scroll down to the list of environments, select Cloud for Sustainability Preview, and then select the More Commands ellipsis (…) next to the name. 
...
1. At the top of the pane, select the **Components** tab, and then do the following:
   ...
   b. In the **URL** box, Change the URL to point to the URL of the Power BI report that you previously copied in a share.

    > [!div class="mx-imgBorder"]
    > [![Screenshot of the subarea "Components" pane, showing a new title and highlighting the changed URL.](../media/custom-dashboard-subarea.png)](../media/custom-dashboard-subarea.png#lightbox)
