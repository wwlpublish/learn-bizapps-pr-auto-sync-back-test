...
1. Create users for these personas:
...
1. Because the retail communication manager will be publishing tasks for store employees by using Microsoft Teams, make sure that they’re assigned an Office 365 E5 license.
...
1. In the **Add a user** dialog, under the **Profile info** section, set the **Job title** as **Retail communications manager** so that the title will appear in Teams.
...
1. Because the store manager will sign in to POS, assign the Dynamics 365 Commerce license.

    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Product licenses page in the Add a user dialog with Dynamics 365 Commerce selected.](../media/commerce.png)](../media/commerce.png#lightbox)

1. In the **Add a user** dialog, on the **Optional settings** page, set the **Job title** as **Store manager**.
...
1. Repeat the previous steps to create a user for store employee and then assign the appropriate licenses.

    > [!div class="mx-imgBorder"]
    > [![Screenshot of the employee user added to the list of users.](../media/employee.png)](../media/employee.png#lightbox)

1. Make sure that the user has the Dynamics 365 Commerce and Office 365 E5 licenses assigned so that they can sign in to Microsoft Teams and mark their tasks as completed.
...
1. Select the **Retail Channel Id** for the first store on the list.
    ...
    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Options page in Finance and Operations with the Retail Channel I D highlighted.](../media/retail.png)](../media/retail.png#lightbox)

1. On the top menu, select **Set up > Workers**.

    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Set up page in Finance and Operations with the Workers option highlighted.](../media/workers.png)](../media/workers.png#lightbox)

1. Find the employee who is the store manager. You can find the role details by selecting the employee's name.

    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Worker page in Finance and Operations with the manager employee highlighted in the list.](../media/worker-manager.png)](../media/worker-manager.png#lightbox)

1. After identifying the store manager, create an Azure AD identity for the employee so that they can sign in to Microsoft Teams. To do so, select **Commerce > Create new identity**.

    > [!div class="mx-imgBorder"]
    > [![Screenshot of the Commerce page in Finance and Operations with the Create new identity button highlighted.](../media/create-identity.png)](../media/create-identity.png#lightbox)

1. In the **Alias** field, define a unique alias that’s based on the worker’s name. The first letter of the first name and last name is the naming convention that’s used in the following example.

   The **UPN** field will be filled in automatically.
...
1. Repeat the previous steps to associate the retail communication manager and store employee workers to their respective user identities in stores, as shown in the following image.
...
## Task 3: Assign the store manager to the retail task manager role
To assign the store manager to the retail task manager role, follow these steps:
...
Congratulations, you’ve successfully assigned the Retail task manager role to the task manager.
...
1. On the **Screen layouts** page, you can choose to design any screen layout and then assign it to the worker who’s associated with your user. For this example, select **C3CSH** by searching for the name **Contoso cashier** in the filter. After you’ve filtered on the name, use the designer to customize the button grids. In this example, you’ll choose **Welcome screen1** and then select **Designer**.
...
1. After you’ve selected the designer, a pop-up window will appear asking you to sign in to access the designer. Sign in with the account that you’ve used for this training.
...
1. Ensure that the screen layout is assigned to the worker who’s associated with your user. To do so, go to **Retail module > Workers** form.
...
1. In the **Commerce** tab, assign the screen layout to the worker, as shown in the following image.
...
1. Provide the **Application ID** (also referred to as **Client ID**), that was generated during the application registration process.
...
1. In the **Finance and Operations** page in Commerce, go to **Retail and Commerce > Channel setup > Microsoft Teams Integration Configuration**.
