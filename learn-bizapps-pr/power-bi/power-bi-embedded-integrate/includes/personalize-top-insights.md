...
In the playground menu, select the **Personalize top insights** showcase.

> [!div class="mx-imgBorder"]
> ![Image shows the Personalize top insights showcase highlighted.](../media/playground-personalize-top-insights-showcase.png)

In the embedded Power BI report, use the vertical scrollbar to scroll to the bottom of the report. Notice that the report page layout contains nine visuals.

At the top left of the page, select **Choose visuals**, and then in the checklist, deselect one or two visuals.
