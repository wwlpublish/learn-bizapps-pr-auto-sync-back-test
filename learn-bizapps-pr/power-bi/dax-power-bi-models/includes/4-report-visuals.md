...
1. Map dataset fields, which are displayed in the **Fields** pane, to the visual field wells. For a bar chart, the wells are **Y-axis**, **X-axis**, **Legend**, **Small multiples**, and **Tooltips**.
