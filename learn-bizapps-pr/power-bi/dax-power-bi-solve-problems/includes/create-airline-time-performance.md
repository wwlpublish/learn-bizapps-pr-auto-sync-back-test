...
```
The formula uses the `CALENDAR` function to return a table of dates between July 1, 2021 and June 30, 2022. The `ADDCOLUMNS` function adds three columns to that table.
...
> [!div class="mx-imgBorder"]
> [![Screenshot shows the Columns well for the table visual, with the Conditional formatting menu options set for the O T P field.](../media/conditional-formatting.png)](../media/conditional-formatting.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot shows the table visual with the O T P and O T P P M Growth columns. An O T P value of 78.01 percent has a red background color.](../media/growth-columns.png)](../media/growth-columns.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot shows the Columns well for the table visual, with the conditional formatting menu options set for the O T P P M Growth field.](../media/growth-formatting.png)](../media/growth-formatting.png#lightbox)
