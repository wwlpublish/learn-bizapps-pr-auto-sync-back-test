...
> [!NOTE]
> To learn about embedding identities and app security setup, work through the [Set up permissions to embed Power BI content](#todo) module.
...
> [!NOTE]
> To learn about developing embedding logic, work through the [Embed Power BI content](#todo) module.
...
> [!NOTE]
> To learn about the Power BI client APIs, work through the [Integrate content with the Power BI client APIs](#todo) module.
