...
**This exercise uses the Power BI service. You'll need to use your organizational account to login. If you don't have one or can't use yours, please create a free [M365 Developer account](https://developer.microsoft.com/en-us/microsoft-365/dev-program) to complete the exercise.**
 ...
 Alternatively, you can use these [**setup instructions**](https://microsoftlearning.github.io/PL-300-Microsoft-Power-BI-Data-Analyst/Instructions/00-setup.html) to create your own lab environment, then follow these [**exercise instructions**](https://microsoftlearning.github.io/PL-300-Microsoft-Power-BI-Data-Analyst/Instructions/07-design-report-in-power-bi-desktop-enhanced.html).
