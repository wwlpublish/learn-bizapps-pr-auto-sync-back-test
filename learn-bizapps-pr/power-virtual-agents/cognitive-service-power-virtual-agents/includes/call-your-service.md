...
> [![Screenshot of Call an action selected to show the Create a flow option.](../media/create-flow.png)](../media/create-flow.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of choosing the type of user input.](../media/input-parameter.png)](../media/input-parameter.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Description showing Please enter your input.](../media/description.png)](../media/description.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Azure Cognitive Service for Language dialog on the Actions tab.](../media/call-connector.png)](../media/call-connector.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of choosing the type of output parameter.](../media/output-parameter.png)](../media/output-parameter.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Trigger phrases user interface.](../media/trigger-phrases.png)](../media/trigger-phrases.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot showing the Identify field on the question node.](../media/create-question.png)](../media/create-question.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot showing Call an action selected to reveal the Detect Customer Sentiment option.](../media/call-action.png)](../media/call-action.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of the Action pane showing Description as an input and Customer sentiment as an output.](../media/customer-sentiment.png)](../media/customer-sentiment.png#lightbox)
...
> [!div class="mx-imgBorder"]
> [![Screenshot of a conversation path showing two of the conditions.](../media/conversation-path.png)](../media/conversation-path.png#lightbox)
