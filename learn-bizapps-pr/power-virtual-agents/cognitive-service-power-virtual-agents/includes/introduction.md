...
One cloud-based service that can help with this task is Microsoft Azure Cognitive Services for Language. It can be used in Power Virtual Agents bots to provide necessary tools to take your bots to the next level. This module will describe how to use Azure Cognitive Services for Language in your Power Virtual Agents bots.

Before you learn about the specifics, you'll first learn about Azure Cognitive Services for Language.
