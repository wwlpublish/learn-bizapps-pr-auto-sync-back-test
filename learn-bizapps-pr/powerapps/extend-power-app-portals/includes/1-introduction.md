...
A common method to communicate with external apps like, for example, payment gateways is to build a standalone web application with an API that can be called from the Power Apps portal front-end.
