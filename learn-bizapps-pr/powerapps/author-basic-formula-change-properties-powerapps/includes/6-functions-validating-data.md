...
You can test this functionality by using the following example to disable a button if the **Text Input** control isn't a valid email address.
...
3.  Modify the **DisplayMode** property of the **Button** control to the
    following formula. (Make sure you rename the control to reference the text input control you just added if it isn't *TextInput4.Text*.)
    ```powerappsfl
