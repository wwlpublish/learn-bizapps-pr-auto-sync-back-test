...
The **Edit Form** has the View, Edit, and New form modes, while the **Display Form** only has the View form mode.

There's an added benefit of the **Form** control for the app maker.
...
Power Apps skill set. Note, forms work with all [tabular data sources](/training/modules/work-with-external-data/1-data-source-overview/?azure-portal=true) except collections.

## Properties of a control

This section isn't unique to the **Form** control but serves as a
