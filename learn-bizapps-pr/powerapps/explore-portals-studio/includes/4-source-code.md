...
When the header is selected in portals Studio, a maker can select the navigation row (Web Link Set) to be used as the site navigation menu.

![Screenshot showing how to modify Header](../media/5-4-change-header.png)
