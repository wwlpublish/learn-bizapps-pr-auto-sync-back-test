Dynamics 365 portals in Power Pages provide a great way for an external audience to view and interact with data from Dynamics 365 applications. Dynamics 365 portals should be a consideration as a pillar in an organization's overall web strategy. Portals can be quickly provisioned to serve a variety of different audiences and workloads.

In this module, you looked at various ways to get started using Dynamics 365 portals and features, including:

- How to select a particular audience and workload before provisioning a Dynamics 365 portals.
- Available Dynamics 365 templates in Power Pages.
...
The next steps are to discover the core features of Power Pages, learn about specific Dynamics 365 features, and examine the alternative portal technologies to support Microsoft business applications.
