...
1. That will open the Power Apps portals admin shortcuts page.
...
1. Select **Add a Custom Domain Name**. A wizard opens to walk you through the steps required to define a custom domain.
...
1. Select **Add new** in the **HOST NAME** section to add the new custom domain name.

1. Enter the domain name and press TAB. The domain name will be validated.

1. Select OK to add a custom domain.
...
1. Press OK to create a new binding.
