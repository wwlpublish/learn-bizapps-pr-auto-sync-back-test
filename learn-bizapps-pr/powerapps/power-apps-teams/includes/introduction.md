...
**Exercise 1: Create Dataverse Instance** You'll start by creating a Team and a Dataverse for Teams environment. You'll create your data model used for the Swag Request scenario in Microsoft Dataverse. This includes creating your tables and columns for the data users will be interacting with in your app.
