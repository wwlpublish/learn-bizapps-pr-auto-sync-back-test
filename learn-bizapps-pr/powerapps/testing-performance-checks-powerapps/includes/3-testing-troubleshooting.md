...
remember to test your app after it is published, in a manner that is
...
Monitor will now track your apps actions, including network performance. You can use this to see what calls to the data source are being made, how long they are taking, and what information is being sent/returned.
