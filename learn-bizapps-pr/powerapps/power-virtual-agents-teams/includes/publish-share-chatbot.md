...
4. Fill in the **Short description** and **Long description** to describe what your chatbot does. Tick **Allow your users to add this bot to a team**, then select Yes on the confirmation message. Select **Save**. Note there are also options here to change the color and icon. 
...
6. Under the Add to a team section, select **Add**.
...
2. Select **Publish** from the navigation menu and **Make the bot available to others**. Then select **Availability options**.
...
4. Read the message to understand how this works (in a real-world situation this is what you should have done before you submit for approval). Select **Submit for admin approval**.
