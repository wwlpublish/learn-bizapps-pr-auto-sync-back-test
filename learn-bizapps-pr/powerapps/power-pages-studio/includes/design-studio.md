...
**Template hub** accelerates creation of the new sites by providing feature-rich templates targeting specific business scenarios. Or start with a default template that includes page structures, navigation, and commonly used pages.
...
* Configure site settings such as identity providers, security, permissions, and more in the **Set up workspace**
