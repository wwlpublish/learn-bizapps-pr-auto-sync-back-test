...
The **Forums** feature is also available on the Community, Modern Community, Customer self-service, Employee self-service, and Partner portals.
...
Different forums are created within the Portal Management app in the **Community** area by creating a forum row. Forums can be set up to represent different high-level topics that are based on the needs and goals of an organization, for example, general discussions, support, and so on.
...
Portal visitors will create new threads, which are stored in the Power Apps portal metadata as **Forum Threads** and will contain at least one post (post row). The post will contain the discussion details and optional file attachments. Depending on permissions, other portal visitors can read or respond to particular threads, which will create additional post records. The collection of posts under a thread will represent a particular discussion or answer to a posted question.
...
To learn how to configure and set up blogs on Power Apps portals, see [Manage blogs](/power-apps/maker/portals/customer-engagement-apps/manage-blogs/?azure-portal=true).
...
The **Ideas** feature is available on the Community portal, Modern Community, Customer self-service portal, and the Employee self-service portal.
...
To configure the Power Apps portals **Knowledge Article** feature, see the [Documentation](/power-apps/maker/portals/customer-engagement-apps/configure-knowledge-categories-articles/?azure-portal=true).
...
To set up and configure the Power Apps portals Case Management features, see [Manage cases in portals](/power-apps/maker/portals/customer-engagement-apps/case-management/?azure-portal=true).
