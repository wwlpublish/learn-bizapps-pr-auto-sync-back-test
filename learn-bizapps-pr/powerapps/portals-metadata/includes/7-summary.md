...
- Various portal metadata rows and how they are used to configure specific aspects of a portal.
- The structure of a webpage row and the various components that are used to render a webpage and show content from multiple languages.
