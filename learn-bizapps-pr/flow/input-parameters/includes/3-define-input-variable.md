...
Continue to select the plus (**+**) icon and then create more input variables for your flow. If you're using the desktop flow that is built on the Contoso Invoice app, define two more variables based on the following values.
