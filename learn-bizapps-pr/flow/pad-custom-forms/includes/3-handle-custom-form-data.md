## Use form data in your desktop flows
...
- A text input with the value **NameInput** as an ID. Populate the value **Name** to the label field and set the field to be required.

- A text input with the value **LastNameInput** as an ID. Populate the value **Last Name** to the label field and set the field to be required.

- A date input with the value **DateBirthInput** as an ID. Populate the value **Date of Birth** to the label field and set the field to be required.
...
In this scenario, use three **Write to Excel worksheet** actions to write the provided name, last name, and date of birth. To achieve that, populate the **Value to write** field with the following expressions:
