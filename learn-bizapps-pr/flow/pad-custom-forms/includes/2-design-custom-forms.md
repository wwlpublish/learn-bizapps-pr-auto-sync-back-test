...
The form elements pane provides a variety of input elements that you can use to ask for specific types of data, such as text, dates, and files. 

Additionally, the available non-interactive elements, such as texts and images, can help you make your forms more user-friendly and appealing. 

Apart from these elements, there are actions that enable you to implement additional functionality to your forms. For example, the submit action can gather the provided user data or function as a cancel button.
