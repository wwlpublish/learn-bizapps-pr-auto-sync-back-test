Microsoft Power Apps uses role-based security for sharing. A security role
...
| Delegate                            | Act on behalf of another user                                           | This role lets code run as or impersonate another user. This role is typically used with another security role to provide access to rows. To learn more, see [Impersonate another user](/power-apps/developer/data-platform/impersonate-another-user).                                                                                                              |
